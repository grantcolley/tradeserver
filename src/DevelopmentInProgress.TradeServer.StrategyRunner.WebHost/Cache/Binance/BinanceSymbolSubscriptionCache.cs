...
//        public BinanceSymbolSubscriptionCache(string symbol, int limit, TradeView.Interface.Model.CandlestickInterval candlestickInterval, IExchangeApi exchangeApi)
//        {
//            Symbol = symbol;
//            Limit = limit;
...
//            subscribeCandlesticks = new SubscribeCandlesticks(symbol, candlestickInterval, limit, ExchangeApi);
//        }
